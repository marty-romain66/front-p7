...
try{
    ...
    return (
        <div   className={`addPost ${modal}`} >
            <form  enctype='multipart/form-data'action='/upload_files' method="post" onSubmit={handlePost} >
                <CloseIcon className="close" onClick={() => dispatch(modalChange("none"))} />
  ...
  <IconButton  color="primary" aria-label="upload picture" component="span">
    <PhotoCamera />
                ...
                <textarea name="" id="" cols="30" rows="10"onChange={handleContenu}  value={contenu}></textarea>
                <button onClick={() => dispatch(modalChange("none"))} type="submit">Envoyer</button>
